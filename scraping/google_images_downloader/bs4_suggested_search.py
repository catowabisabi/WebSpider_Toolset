# https://replit.com/@DimitryZub1/Scrape-and-Download-Google-Images-with-Python#bs4_suggested_search.py
...
params = {
    "q": "minecraft shaders 8k photo",  # search query
...
def get_suggested_search_data(search_query):
